...
do{
  ...
  switch(escolhaJogador){
    case 1:
      printf("Escolha:\n1 - População: Carta %d venceu\n",(populacao[0] > populacao[1])? 1 : 2);
      break;

    case 2:
      printf("Escolha:\n2 - Área: Carta %d venceu\n",(area[0] > area[1])? 1 : 2);
      break;

    case 3:
      printf("Escolha:\n3 - PIB: Carta %d venceu\n",(pib[0] > pib[1])? 1 : 2);
      break;

    case 4:
      printf("Escolha:\n4 - Pontos Turísticos: Carta %d venceu\n",(pontosTuristicos[0] > pontosTuristicos[1])? 1 : 2);
      break;

    case 5:
      printf("Escolha:\n5 - Densidade Populacional: Carta %d venceu\n",(densidadePopulacional[0] < densidadePopulacional[1])? 1 : 2);
      break;

    case 6:
      printf("Escolha:\n6 - PIB per Capita: Carta %d venceu\n",(pibPerCarpita[0] > pibPerCarpita[1])? 1 : 2);
      break;

    case 7:
      printf("Escolha:\n7 - Super Poder: Carta %d venceu\n",(superPoder[0] > superPoder[1])? 1 : 2);
      break;
  }
